...
from YOLOv5writtencode.utils.utils import xyxy2xywh, xywh2xyxy, torch_distributed_zero_first
...
class LoadImages_IB:  # for inference
    ...
    def __next__(self):
        ...
        if self.video_flag[self.count]:
            ...
            # Read image
            self.count += 1
            new= pyautogui.screenshot(region=(290,560,490,740))
            img0 = cv2.cvtColor(np.array(new),cv2.COLOR_RGB2BGR)  # BGR
